...
MODEL_REGISTRY: dict[str, dict[str, Any]] = {  
    ...
    "musseg_pi_se_lsa_ba_dist_attn": {
        "family": "phasenet",
        "trainer_kind": "1d",
        "display_name": "MuSSeg_PI_SE_LateStationAttention_BA_DistAttn",
        "model_cls": MuSSeg,
        "model_kwargs": {
            **deepcopy(PHASENET_PERMUTATION_INVARIANT_BASE_KWARGS),
            "bottleneck_attention": True,
    ...
    "musseg_pi_se_lsa_ba_dist_emb": {
        "family": "phasenet",
        "trainer_kind": "1d",
        "display_name": "MuSSeg_PI_SE_LateStationAttention_BA_DistEmb",
        "model_cls": MuSSeg,
        "model_kwargs": {
            **deepcopy(PHASENET_PERMUTATION_INVARIANT_BASE_KWARGS),
            "bottleneck_attention": True,
    ...
    "musseg_pi_se_lsa_ba_dist_both": {
        "family": "phasenet",
        "trainer_kind": "1d",
        "display_name": "MuSSeg_PI_SE_LateStationAttention_BA_DistBoth",
        "model_cls": MuSSeg,
        "model_kwargs": {
            **deepcopy(PHASENET_PERMUTATION_INVARIANT_BASE_KWARGS),
            "bottleneck_attention": True,
